...
<div class="flex flex-col h-screen bg-gray-800">
    <div class="grid place-items-center mx-2 my-20 sm:my-auto">
        <div class="w-11/12 p-12 sm:w-8/12 md:w-6/12 lg:w-5/12 2xl:w-4/12 
            ...
            <form class="mt-10" method="POST" action="{{route('editar_Empleado', [$id])}}">
                @csrf
                @method('PUT')
                <!-- Name Input -->
                <label for="name" class="block text-xs font-semibold text-gray-600 uppercase">Nombre</label>
                <input id="name" type="text" value="{{$user->name}}" name="name" placeholder="Nombre" autocomplete="nombre" class="block w-full py-3 px-1 mt-2 
                ...
                <input id="celular" value="{{$user->celular}}" type="phonenumber" name="celular" placeholder="Celular" autocomplete="celular" class="block w-full py-3 px-1 mt-2 
                    text-gray-800 appearance-none 
                    border-b-2 border-gray-100
                    focus:text-gray-500 focus:outline-none focus:border-gray-200" required />
                ...
                <input id="email" value="{{$user->email}}" type="email" name="email" placeholder="E-mail address" autocomplete="email" class="block w-full py-3 px-1 mt-2 
                    text-gray-800 appearance-none 
                    border-b-2 border-gray-100
                    focus:text-gray-500 focus:outline-none focus:border-gray-200" required />
                ...
                <input id="password" type="password" name="password" class="block w-full py-3 px-1 mt-2 mb-4
                    text-gray-800 appearance-none 
                    border-b-2 border-gray-100
                    focus:text-gray-500 focus:outline-none focus:border-gray-200" required />
