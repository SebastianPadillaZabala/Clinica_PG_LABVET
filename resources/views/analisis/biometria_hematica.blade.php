...
<body class="bg-gray-200 print:bg-white pt-5 md:flex lg:flex xl:flex print: md:justify-center lg:justify-center xl:justify-center print:justify-center sf">
  <div class="w-full bg-white lg:w-full xl:w-2/3 lg:mt-5 lg:mb-20 lg:shadow-xl xl:mt-2 xl:mb-20 xl:shadow-xl print:transform print:scale-90">
    <header class="flex flex-col items-center rounded-md px-8 pt-5 text-lg text-center bg-white border-t-8 border-blue-800 md:block lg:block xl:block print:block md:items-start lg:items-start xl:items-start print:items-start md:text-left lg:text-left xl:text-left print:text-left print:pt-3 print:px-1 md:relative lg:relative xl:relative print:relative">
      ...
      <div class="flex flex-row mt-5 mb-2 ml-0 text-center font-bold md:text-xl lg:text-xl xl:text-xl print:text-xl lg:ml-12 xl:ml-12 justify-center">BIOMETRIA HEMATICA
      </div>
    ...
    <content>
      <div id="content" class="flex justify-start print:mt-3">
        <table class="w-full text-left border-t text-sm border-b border-l border-r table-auto print:text-sm" id="table-items">
          <thead>
            <tr class="text-white bg-gray-700 text-sm print:bg-gray-300 print:text-black print:text-sm">
              ...
              <th class="px-2 py-1 text-center print:hidden">ACCIONES</th>
            </tr>
          </thead>
          <tbody class="text-sm print:text-sm">
            <tr>
              <td class="px-2 py-1 border font-bold">Globulos rojos</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">/mm3</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">4.500.000 - 10.500.000/mm3</td>
            ...
            <tr class="bg-gray-100 print:bg-white">
              <td class="px-2 py-1 border font-bold">Hemoglobina</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">g%</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">8.5 - 15 g%</td>
              <td class="px-2 py-1 text-center print:hidden">
                <button class="px-2 py-1 bg-red-500 text-white print:hidden" onclick="eliminarFila(this)">Eliminar</button>
              </td>
            </tr>
            <tr>
              ...
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">%</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-z2ro">16 - 48 %</td>
              <td class="px-2 py-1 text-center print:hidden">
                <button class="px-2 py-1 bg-red-500 text-white print:hidden" onclick="eliminarFila(this)">Eliminar</button>
              </td>
            </tr>
            <tr class="bg-gray-100 print:bg-white">
              ...
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">fL</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">38 - 54 fL</td>
              <td class="px-2 py-1 text-center print:hidden">
                <button class="px-2 py-1 bg-red-500 text-white print:hidden" onclick="eliminarFila(this)">Eliminar</button>
              </td>
            </tr>
            <tr class="bg-white print:bg-white">
              ...
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">pg</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">11 - 18 pg</td>
              <td class="px-2 py-1 text-center print:hidden">
                <button class="px-2 py-1 bg-red-500 text-white print:hidden" onclick="eliminarFila(this)">Eliminar</button>
              </td>
            </tr>
            ...
            <tr class="bg-gray-100 print:bg-white">
              <td class="px-2 py-1 border font-bold">Cayados</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">%</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">0 - 3 %</td>
              <td class="px-2 py-1 text-center print:hidden">
                <button class="px-2 py-1 bg-red-500 text-white print:hidden" onclick="eliminarFila(this)">Eliminar</button>
              </td>
            </tr>
            <tr class="bg-white print:bg-white">
              <td class="px-2 py-1 border font-bold">Neutrofilos</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">%</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">60 - 77 %</td>
              <td class="px-2 py-1 text-center print:hidden">
                <button class="px-2 py-1 bg-red-500 text-white print:hidden" onclick="eliminarFila(this)">Eliminar</button>
              </td>
            </tr>
            <tr class="bg-gray-100 print:bg-white">
              <td class="px-2 py-1 border font-bold">Eosinofilos</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">%</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">1 - 6 %</td>
              <td class="px-2 py-1 text-center print:hidden">
                <button class="px-2 py-1 bg-red-500 text-white print:hidden" onclick="eliminarFila(this)">Eliminar</button>
              </td>
            </tr>
            <tr class="bg-white print:bg-white">
              <td class="px-2 py-1 border font-bold">Basofilos</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">%</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">0 - 1 %</td>
              <td class="px-2 py-1 text-center print:hidden">
                <button class="px-2 py-1 bg-red-500 text-white print:hidden" onclick="eliminarFila(this)">Eliminar</button>
              </td>
            </tr>
            <tr class="bg-gray-100 print:bg-white">
              <td class="px-2 py-1 border font-bold">Linfocitos</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">%</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">12 - 30 %</td>
              <td class="px-2 py-1 text-center print:hidden">
                <button class="px-2 py-1 bg-red-500 text-white print:hidden" onclick="eliminarFila(this)">Eliminar</button>
              </td>
            </tr>
            <tr class="bg-white print:bg-white">
              <td class="px-2 py-1 border font-bold">Monocitos</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">%</td>
              <td class="px-2 py-1 text-center border tabular-nums slashed-zero">3 - 8 %</td>
              <td class="px-2 py-1 text-center print:hidden">
                <button class="px-2 py-1 bg-red-500 text-white print:hidden" onclick="eliminarFila(this)">Eliminar</button>
              </td>
            </tr>
    ...
    <div class="flex flex-col items-center mb-0 leading-relaxed print:mt-0 print:mb-0">
      ...
      <img src="/storage/img/firma.jpeg" class="w-64 text-4xl text-center print:text-lg print:mt-5 print:mb-0" />
    </div>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    agregarFilaBtn.addEventListener("click", function() {
      ...
      cell1.innerHTML = '<input type="text" class="px-2 py-1 border font-bold">';
      cell2.innerHTML = '<input type="text" class="px-4 py-1 border text-center tabular-nums slashed-zero">';
      cell3.innerHTML = '<input type="text" class="px-4 py-1 border text-center tabular-nums slashed-zero">';
      cell4.innerHTML = '<input type="text" class="px-4 py-1 border text-center tabular-nums slashed-zero">';
      cell5.innerHTML = '<button class="px-2 py-1 bg-red-500 borde text-white print:hidden" onclick="eliminarFila(this)">Eliminar</button>';
    });
  });
