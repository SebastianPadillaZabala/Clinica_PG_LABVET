...
<body class="bg-gray-200 print:bg-white pt-5 md:flex lg:flex xl:flex print: md:justify-center lg:justify-center xl:justify-center print:justify-center sf">
  <div class="w-full bg-white lg:w-full xl:w-2/3 lg:mt-5 lg:mb-20 lg:shadow-xl xl:mt-2 xl:mb-20 xl:shadow-xl print:transform print:scale-90">
      ...
      <div id="content" class="flex flex-col items-center md:p-8 lg:p-2 xl:p-2 print:mt-3 print:p-1 print:gap-2">
        ...
        <table class="w-2/3 text-left border-t border-b border-l border-r table-auto print:text-sm" id="table-items">
          <tbody>
            ...
            <tr>
              <td class="px-4 py-2 border font-bold">TINCION GRAM</td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center w-full">
              </td>
            </tr>
            <tr>
              <td class="px-4 py-2 border font-bold">RECUENTO DE COLONIAS</td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center w-full">
              </td>
            </tr>
            ...
            <tr class="bg-white print:bg-white">
              <td class="px-4 py-2 border font-bold">DIAGNOSTICO MICROBIOLOGICO</td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center w-full">
              </td>
            </tr>
    ...
    <div class="flex flex-col items-center md:p-8 lg:p-2 xl:p-2 print:mt-1 print:p-2 print:gap-2">
      <h1 class="text-xl font-bold">ANTIBIOGRAMA</h1>
      <table class="w-full text-left border-t border-b border-l border-r table-auto print:text-sm">
        <thead>
