        ...
        <table class="w-full text-left border-t border-b border-l border-r table-auto print:text-xs" id="table-items">
          ...
          <tbody>
            ...
            <tr class="bg-gray-100 print:bg-white">
              ...
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">0.5 - 1.6 mg/dL</td>
            </tr>
            <tr>
              ...
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">20 - 50 mg/dL</td>
            </tr>
            <tr class="bg-gray-100 print:bg-white">
              <td class="px-4 py-2 border font-bold">
                NITROGENO UREICO
              ...
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">7 - 27 mg/dL</td>
            </tr>
            ...
            <tr class="bg-white print:bg-white">
              ...
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">2.3 - 3.8 g/dL</td>
            </tr>
            <tr class="bg-gray-100 print:bg-white">
            ...
            <tr class="bg-white print:bg-white">
              <td class="px-4 py-2 border font-bold">AMILASA</td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">269 - 1462 U/L</td>
            </tr>
            <tr class="bg-gray-100 print:bg-white">
              <td class="px-4 py-2 border font-bold">LIPASA</td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">50.0 - 470 U/L</td>
            </tr>
            <tr class="bg-white print:bg-white">
              <td class="px-4 py-2 border font-bold">TRIGLICERIDOS</td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">25 - 120 mg/dL</td>
            </tr>
            <tr class="bg-white print:bg-white">
              <td class="px-4 py-2 border font-bold">COLESTEROL</td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">80 - 180 mg/dL</td>
            </tr>
            <tr class="bg-white print:bg-white">
              <td class="px-4 py-2 border font-bold">FOSFORO</td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">2.0 - 6.2 mg/dL</td>
            </tr>
            <tr class="bg-white print:bg-white">
              <td class="px-4 py-2 border font-bold">SODIO</td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">135 - 150 meq/L</td>
            </tr>
            <tr class="bg-white print:bg-white">
              <td class="px-4 py-2 border font-bold">POTASIO</td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">3,6 - 5,8 meq/L</td>
            </tr>
            <tr class="bg-white print:bg-white">
              <td class="px-4 py-2 border font-bold">CLORO</td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">105 - 120 meq/L</td>
            </tr>
            <tr class="bg-white print:bg-white">
              <td class="px-4 py-2 border font-bold">CALCIO TOTAL</td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">
                <input type="text" class="text-center">
              </td>
              <td class="px-4 py-2 text-center border tabular-nums slashed-zero">7 - 11,5 mg/dL</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <div class="bg-teal-600 rounded shadow-lg w-10/12 md:w-1/3">
    ...
    <div class="p-3 text-white">
      <form action="{{route('saveAnalisisM', [$id])}}" method="POST" enctype="multipart/form-data">
        ...
        <input id="name" name="name" value="Quimica Sanguinea Can" class="mb-5 mt-2 text-black focus:outline-none focus:border focus:border-white font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" />
