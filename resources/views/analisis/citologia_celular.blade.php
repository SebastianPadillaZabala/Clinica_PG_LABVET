        ...
        <content>
            <div id="content" class="flex flex-col justify-center md:p-8 lg:p-2 xl:p-2 print:mt-5 print:justify-center print:p-1">
                <div class="flex flex-col items-start gap-1 mb-5 m-8 leading-relaxed print:mt-1 print:mb-20">
                    <h1 class="text-l font-bold">Observaci&oacute;n macrosc&oacute;pica</h1>
                    <textarea rows="3" cols="95"></textarea>
                    <h1 class="text-l font-bold">Observacion microsc&oacute;pica</h1>
                    <textarea rows="3" cols="95"></textarea>
                    <h1 class="text-l font-bold">Diagnostico citol&oacute;gico</h1>
  ...
  <div class="bg-teal-600 rounded shadow-lg w-10/12 md:w-1/3">
    ...
    <div class="p-3 text-white">
      <form action="{{route('saveAnalisisM', [$id])}}" method="POST" enctype="multipart/form-data">
        ...
        <input id="name" name="name" value="Citologia Celular" class="mb-5 mt-2 text-black focus:outline-none focus:border focus:border-white font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"/>
